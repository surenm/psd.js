...
arraySum = function(arr, from, to) {
  ...
  END DEPENDENCIES
  */
  var Log, PSD, PSDDropDownLayerEffect, PSDFile, PSDHeader, PSDImage, PSDLayer, PSDLayerEffect, PSDLayerEffectCommonStateInfo, PSDLayerMask, PSDResource, Root, Util, fs,
  ...
  PSDLayer = (function() {
    ...
    PSDLayer.prototype.parseEffectsLayer = function() {
      var count, effect, signature, size, type, v, _ref, _ref2, _results;
      ...
      while (count-- > 0) {
        ...
        if (effect != null) {
          ...
          this.file.seek(size);
          _results.push(Log.debug("Skipping effect layer with type " + type));
        }
      }
      return _results;
    };
  ...
  PSDLayerEffectCommonStateInfo = (function(_super) {
    ...
    function PSDLayerEffectCommonStateInfo(file) {
      PSDLayerEffectCommonStateInfo.__super__.constructor.call(this, file);
    }
