  ...
  */
  ...
  PSDLayer = (function() {
    ...
    PSDLayer.prototype.parseExtraData = function() {
      var length, pos, _ref;
      _ref = this.file.readf(">4s4s"), this.signature = _ref[0], this.key = _ref[1];
      length = this.file.readUInt();
      return pos = this.file.tell();
    };
    ...
    PSDLayer.prototype.parseImageData = function() {
      ...
      while (this.file.tell() < this.layerEnd) {
        _results.push(this.compression = this.file.readShortInt());
      }
      return _results;
    };
